...
def attack(char_name: str, char_class: str) -> str:
    """Расчет нанесенного урона в зависимости от класса игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчет заблокированного урона в зависимости от класса игрока."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Использование игроком специального умения.
    Расчет параметров в зависимости от класса игрока.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка боя для персонажа игрока.
    Считывает действия с клавиатуры и запускает соответствующую функцию.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса персонажа с его описанием."""
